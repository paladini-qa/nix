...
const AnalyticsView: React.FC<AnalyticsViewProps> = ({ transactions }) => {
  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", gap: isMobile ? 2 : 3 }}>
        ...
        <Grid size={{ xs: 6, md: 3 }}>
          <Paper
            sx={{
              p: 2,
              textAlign: "center",
              background: `linear-gradient(135deg, ${alpha("#6366f1", 0.1)} 0%, ${alpha("#6366f1", 0.02)} 100%)`,
        ...
        <Grid size={{ xs: 6, md: 3 }}>
          <Paper
            sx={{
              p: 2,
              textAlign: "center",
              background: `linear-gradient(135deg, ${alpha("#8b5cf6", 0.1)} 0%, ${alpha("#8b5cf6", 0.02)} 100%)`,
      ...
      <Paper sx={{ p: isMobile ? 2 : 3 }}>
        <SectionHeader icon={<TimelineIcon />} title="Fluxo de Caixa (30 dias)" />
        <Box sx={{ height: isMobile ? 250 : 300 }}>
          <ResponsiveContainer width="100%" height="100%">
      ...
      <Grid container spacing={isMobile ? 2 : 3}>
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          <Paper sx={{ p: isMobile ? 2 : 3 }}>
            <SectionHeader icon={<PieChartIcon />} title="Despesas por Categoria" />
            {categoryData.length > 0 ? (
              ...
              <Box sx={{ py: 4, textAlign: "center" }}>
                <Typography color="text.secondary">Sem despesas no período</Typography>
              </Box>
            )}
          </Paper>
        </Grid>
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          <Paper sx={{ p: isMobile ? 2 : 3 }}>
            <SectionHeader icon={<TrendingUpIcon />} title="Receitas por Categoria" />
            {incomeByCategory.length > 0 ? (
              ...
              <Box sx={{ py: 4, textAlign: "center" }}>
                <Typography color="text.secondary">Sem receitas no período</Typography>
              </Box>
            )}
          </Paper>
        </Grid>
          ...
          {categoryData.slice(0, 5).map((cat, index) => (
            <Box
              ...
              sx={{
                ...
                border: `1px solid ${alpha(COLORS[index % COLORS.length], 0.15)}`,
              }}
            >
