    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2 w-full xl:w-auto">
          ...
          <button
            className="p-2 text-gray-600 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-white/10 rounded-lg border border-gray-200 dark:border-white/10 transition-colors"
            title="Export"
          >
            <Download size={20} />
          </button>
